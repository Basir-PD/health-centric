...
export default function CTA() {
  return (
    <section id="pricing" className="relative py-16 sm:py-24 lg:py-32 bg-[#faf8f5] dark:bg-gray-950">
      {/* Subtle grid pattern */}
      <div className="absolute inset-0 bg-[linear-gradient(rgba(0,0,0,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(0,0,0,0.03)_1px,transparent_1px)] dark:bg-[linear-gradient(rgba(255,255,255,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.03)_1px,transparent_1px)] bg-[size:32px_32px] sm:bg-[size:48px_48px]" />
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 sm:gap-12">
          ...
          <div className="lg:max-w-xl">
            ...
            <p
              className="mt-4 sm:mt-6 text-base sm:text-lg text-gray-600 dark:text-gray-400 leading-relaxed"
            ...
            {/* Trust badges */}
            <div className="mt-6 sm:mt-8 flex flex-wrap items-center gap-4 sm:gap-6 text-xs sm:text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="flex flex-col gap-4 sm:gap-6 sm:flex-row lg:flex-col xl:flex-row">
            {/* Main Card */}
            <div className="group relative rounded-2xl sm:rounded-3xl bg-white dark:bg-gray-900 p-5 sm:p-8 flex-1 min-w-0 sm:min-w-[300px] transition-all duration-500 hover:scale-[1.02] hover:-translate-y-1"
            ...
            >
              ...
              <div className="text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-400 mt-2">Comprehensive Panel</div>
              <div className="mt-3 sm:mt-4 flex items-baseline gap-2">
                ...
                <span className="text-sm sm:text-base text-gray-500 dark:text-gray-400">/test</span>
              </div>
              ...
              <p className="mt-3 sm:mt-4 text-center text-[10px] sm:text-xs text-gray-400 dark:text-gray-500">
                HSA/FSA eligible • No subscription required
              </p>
            </div>

            {/* Subscription Option */}
            <div className="group rounded-xl sm:rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900/50 p-4 sm:p-6 flex-1 min-w-0 sm:min-w-[280px] transition-all duration-500 hover:border-gray-300 dark:hover:border-gray-700 hover:scale-[1.02] hover:-translate-y-1 hover:shadow-lg dark:hover:shadow-gray-900/50">
              <div className="flex items-center justify-between gap-2">
                <div className="text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300">Subscribe & Save</div>
                <div
              ...
              <div className="mt-3 sm:mt-4 flex items-baseline gap-1 sm:gap-2 flex-wrap">
                ...
                <span className="text-xs sm:text-base text-gray-500 dark:text-gray-400">/test</span>
                <span className="text-xs sm:text-sm text-gray-400 dark:text-gray-500 line-through ml-1 sm:ml-2">$299</span>
              </div>

              <ul className="mt-4 sm:mt-6 space-y-2 sm:space-y-3 text-xs sm:text-sm text-gray-600 dark:text-gray-400">
                {[
                  ...
                  <li key={i} className="flex items-center gap-2 transition-colors duration-300 group-hover:text-gray-700 dark:group-hover:text-gray-300">
        ...
        <div className="mt-10 sm:mt-16 text-center px-4">
          <p className="text-gray-500 dark:text-gray-400 text-xs sm:text-sm" style={{ fontFamily: 'var(--font-body)' }}>
            Have questions?{' '}
            <Link
              href="#contact"
            ...
            {' '}or call <span className="text-gray-900 dark:text-white font-medium">1-800-HEALTH</span>
          </p>
        </div>
      </div>
    </section>
