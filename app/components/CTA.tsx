...
export default function CTA() {
  return (
    <section className="relative py-24 lg:py-32 bg-[#faf8f5]">
      {/* Subtle grid pattern */}
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-12">
          ...
          <div className="lg:max-w-xl">
            <h2
              className="text-3xl sm:text-4xl lg:text-5xl font-medium tracking-tight text-gray-900"
          ...
          <div className="flex flex-col sm:flex-row gap-6 lg:flex-col xl:flex-row">
            {/* Main Card */}
            <div className="group relative rounded-3xl bg-white p-8 flex-1 min-w-[300px] transition-all duration-500 hover:scale-[1.02] hover:-translate-y-1"
              style={{ boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.15)' }}
            >
              {/* Decorative corner accent */}
              <div
                className="absolute top-0 right-0 w-24 h-24 opacity-10 rounded-tr-3xl"
              ...
              <div className="text-sm font-medium text-gray-500 mt-2">Comprehensive Panel</div>
              ...
              <Link
                href="#get-started"
                className="mt-8 block w-full rounded-xl px-6 py-4 text-center font-semibold text-white transition-all duration-300 hover:brightness-110 active:scale-[0.98]"
                style={{
            ...
            {/* Subscription Option */}
            <div className="group rounded-2xl border border-gray-200 bg-white p-6 flex-1 min-w-[280px] transition-all duration-500 hover:border-gray-300 hover:scale-[1.02] hover:-translate-y-1 hover:shadow-lg">
              <div className="flex items-center justify-between">
                <div className="text-sm font-medium text-gray-700">Subscribe & Save</div>
                <div
              ...
              <div className="mt-4 flex items-baseline gap-2">
                ...
                <span className="text-gray-500">/test</span>
                <span className="text-sm text-gray-400 line-through ml-2">$299</span>
              </div>
              ...
              <ul className="mt-6 space-y-3 text-sm text-gray-600">
                {[
                  ...
                  <li key={i} className="flex items-center gap-2 transition-colors duration-300 group-hover:text-gray-700">
                    <svg className="h-4 w-4 flex-shrink-0" style={{ color: 'var(--color-brand)' }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                    </svg>
                    <span>{feature}</span>
                  </li>
              ...
              <Link
                href="#subscribe"
                className="mt-6 block w-full rounded-xl border-2 px-6 py-3 text-center font-medium transition-all duration-300 hover:bg-[rgba(184,101,74,0.05)] active:scale-[0.98]"
